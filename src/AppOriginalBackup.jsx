      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 18px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid var(--border)", borderRadius: "var(--radius-sm)", padding: "14px 16px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: weather ? 12 : 0 }}>
            <div style={{ color: "var(--text2)", fontSize: 13, fontWeight: 600 }}>🌤 Conditions at this spot</div>
          ...
          {weather && !weather.error && (
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "var(--text)" }}>🌡️ {weather.temp}°F</div>
                <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "var(--text)" }}>💨 {weather.windSpeed} mph {weather.windDir}</div>
                <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "var(--text)" }}>☁️ {weather.cloudcover}%</div>
                ...
                {weather.precip > 0 && <div style={{ background: "rgba(80,140,220,0.15)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "#7ab0e0" }}>🌧️ {weather.precip}mm precip</div>}
                {weather.sunrise && <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "var(--text)" }}>🌅 {weather.sunrise}</div>}
                {weather.sunset && <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "8px 12px", fontSize: 13, color: "var(--text)" }}>🌇 {weather.sunset}</div>}
              </div>
              {windMatch !== null && (
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 14px", borderRadius: 12, background: windMatch ? "rgba(120,180,80,0.12)" : "rgba(255,80,80,0.1)", border: `1px solid ${windMatch ? "rgba(120,180,80,0.3)" : "rgba(255,80,80,0.25)"}` }}>
                  <span style={{ fontSize: 18 }}>{windMatch ? "🟢" : "🔴"}</span>
